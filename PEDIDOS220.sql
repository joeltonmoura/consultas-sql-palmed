SELECT 
    ...
    ,SUM(F.QTPALMAS+F.QTMARABA+F.QTTERESINA+F.QTMARANHAO+F.QTCABEDELO+F.QTCASTANHAL) TOTALPRODUTOS
    ,SUM(F.PLIQUIDO * (F.QTPALMAS+F.QTMARABA+F.QTTERESINA+F.QTMARANHAO+F.QTCABEDELO+F.QTCASTANHAL)) TOTAL
FROM 
(SELECT 
     PCPEDIDO.CODFORNEC
    ,PCFORNEC.FORNECEDOR
...
AND PCPEDIDO.DTEMISSAO BETWEEN TO_DATE('01/04/2020','DD/MM/YYYY') AND TO_DATE('14/04/2020','DD/MM/YYYY')
